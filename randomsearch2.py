        ...
        if self.iteration % self.it_per_evaluation == 0:
            if self.nbEval < 3:
                ...
                if current_score > self.max_score:
                    ...
                    self.nbEval += 1
                print("Fin Trial" +str(self.trial) +"-"+str(self.nbEval)+" : Score = "+str(current_score)+" | Max = "+str(self.max_score)+ "| Best Trial = "+str(self.best_trial)+"| Best Param = "+str(self.bestParam))
