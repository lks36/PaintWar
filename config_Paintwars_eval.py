...
import robot_challenger_autre
import robot_challenger_autre1
...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    for i in range(4):
        robots.append(robot_challenger_autre.Robot_player(x_init_pos[0], arena_size//2-16+i*8, orientation_champion, name="", team="A"))
    for i in range(4):
        robots.append(robot_challenger_autre1.Robot_player(x_init_pos[1], arena_size//2-16+i*8, orientation_challenger, name="", team="B"))
    return robots
